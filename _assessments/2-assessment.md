...
| [Lab Extension]({{site.baseurl}}/assessments/5-lab-extension) | Completes a substantive, deep, (largely) self-guided exploration of one DH method and develops an extended and effective critical analysis in their write-up | Completes an exploration of one DH method and develops a critical analysis in their write up | Does not develop an experiment or complete the expected analysis |
